...
def read_file(file_):
  name = '/Users/agatorano/Code/metascape/metascape.org/static/Table_S4.xlsx'
  xls1 = pd.read_excel(name,index_col=None, na_values=['NA'])

  if len(file_)>0:
    name = '/Users/agatorano/Code/metascape/metascape.org/media/'+file_
...
def get_list(z_score,screens,flu_protein,word_search,file_):
  ...
  name = '/Users/agatorano/Code/metascape/metascape.org/static/proteinatlas.xlsx'
  ...
  go_ = go.GO(DIR='/Users/agatorano/Code/metascape/metascape.org/static/')
...
def save_file(xls_out):
  ...
  path='/Users/agatorano/Code/metascape/metascape.org/media/IAV/%s/'%(date_)
  media_path='IAV/%s/'%date_+filename
